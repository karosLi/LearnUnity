...
namespace LibBase.MathLite.FixMath {
    ...
    public struct FixRandom {
        ...
        /**
         *  @brief Returns a {@link FixFloat} between a min value [inclusive] and a max value [inclusive].
         **/
        public FixFloat Next(float minValue, float maxValue) {
            ...
            return (FixFloat.Floor((maxValueInt - minValueInt + 1) * NextFixFloat() +
                minValueInt)) / 1000;
        }
         ...
         *  @brief Returns a {@link FixFloat} between a min value [inclusive] and a max value [inclusive].
         **/
        public FixFloat Range(float minValue, float maxValue) {
            return Next(minValue, maxValue);
        }

        public FixFloat RangeFloat(FixFloat minValue, FixFloat maxValue)
        {
            return Next(minValue, maxValue);
        }
        
        /**
         *  @brief Returns a {@link FixFloat} between 0.0 [inclusive] and 1.0 [inclusive].
         **/
        ...
        public FVec3 insideUnitSphere {
            get {
                return new FVec3(value, value, value);
            }
        }
        ...
        FixFloat genrand_FixFloat() {
            return (FixFloat)genrand_int32() * (FixFloat.One / (FixFloat)4294967295);
        }
