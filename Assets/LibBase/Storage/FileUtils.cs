        ...
        public static byte[] ReadFile(string fullpath, int readsize = 0) {
            ...
            if (File.Exists(fullpath)) {
                ...
                try {
                    ...
                    // Log.E("ReadFile() Path:{0}, Error:{1}", fullpath, e.Message);
                } finally {
                    if (fs != null) {
                        fs.Close();
                    }
                ...
                // Log.E("ReadFile() File is Not Exist: {0}", fullpath);
            }
        ...
        public static string[] ReadFileLines(string fullpath) {
            ...
            if (File.Exists(fullpath)) {
                ...
                try {
                    ...
                    // Log.E("ReadFileLines() Path:{0}, Error:{1}", fullpath, e.Message);
                } finally {
                    if (fs != null) {
                        fs.Close();
                    }
                ...
                // Log.E("ReadFileLines() File is Not Exist: {0}", fullpath);
            }
        ...
        public static int SaveFile(string fullpath, byte[] content) {
            ...
            if (!Directory.Exists(dir)) {
                try {
                    ...
                    // Log.E("SaveFile() CreateDirectory Error! Dir:{0}, Error:{1}", dir, e.Message);
                    return -1;
                }
            }
            ...
            try {
                ...
                // Log.E("SaveFile() Path:{0}, Error:{1}", fullpath, e.Message);
                fs.Close();
                return -1;
            }
